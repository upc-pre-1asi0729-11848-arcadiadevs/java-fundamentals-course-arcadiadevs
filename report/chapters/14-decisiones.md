...
Para esta clase continuaremos usando **OnlineGDB**, el mismo entorno en línea que usamos la clase pasada. No necesitas instalar nada en tu computadora. Haz clic en el siguiente enlace para abrir el código inicial de la clase ya precargado: **[Abrir OnlineGDB - Código inicial precargado: https://onlinegdb.com/SGfcIy9Wp](https://onlinegdb.com/SGfcIy9Wp)**
...
![Ilustración de Elección entre dos rutas](../assets/class-4/eleccion-caminos.jpg){width=50%}
...
![Ilustración de If-else](../assets/class-4/if-else.jpg){width=80%}
