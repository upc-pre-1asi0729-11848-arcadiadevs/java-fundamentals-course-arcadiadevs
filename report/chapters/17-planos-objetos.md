...
- **[Abrir Replit - Planos y Objetos](https://replit.com/@your-starter-java)**
- **[Abrir JDoodle - Planos y Objetos](https://jdoodle.com/execute-java-online/your-id)**
...
**Resumen**
Una Clase es un plano o molde (no existe físicamente), y un Objeto es la creación real usando la palabra `new` y el Constructor. Tu desafío para hoy será hornear galletas literales en programación, creando la clase Galleta. Nos vemos en nuestra última clase del curso. ¡Felicidades por llegar tan lejos!
